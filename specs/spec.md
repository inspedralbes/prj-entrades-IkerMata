# Comportament esperat — capability `session-seats-initial-state`

**Font canònica:** `openspec/changes/sincronitzacio-estat-butaques-inicial/specs/session-seats-initial-state/spec.md`
